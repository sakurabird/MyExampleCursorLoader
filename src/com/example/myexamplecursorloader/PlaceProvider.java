...
import com.example.myexamplecursorloader.data.DatabaseHelper;
...
public class PlaceProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (URI_MATCHER.match(uri)) {
            case PLACE:
                return PlaceManager.Place.CONTENT_TYPE; // expect the Cursor to contain 0..x items
            case PLACE_ID:
                return PlaceManager.Place.CONTENT_ITEM_TYPE; // expect the Cursor to contain 1 item
            default:
                throw new IllegalArgumentException("Unknown URL " + uri);
        }
        //@formatter:on
